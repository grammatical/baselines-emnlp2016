...
my $i = 0;
my @files = <$DIR/cross.*/work.err-cor/binmodel.err-cor/moses.mert.?.?.ini>;
@files = map { s/\.\d\.\d.ini/.ini/; $_ } @files;
if ($ITERATION > 0) {
    @files = <$DIR/cross.*/work.err-cor/binmodel.err-cor/moses.mert.?.$ITERATION.ini>;
...
open(INIS, "paste $DIR/cross.*/work.err-cor/binmodel.err-cor/moses.mert.?.$suffix.ini |") or die "Problem 1\n";
my @inis = <INIS>;
close(INIS);
